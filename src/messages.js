...
export const CREATE_BUG_TITLE = '<h3>Чем подробнее вы опишите действия для воспроизведения ошибки тем раньше мы сможем ее устронить. Спасибо за то, что помогаете сделать сервис лучше!</h3>' +
  '<div class="pt-2">Опишите шаги воспроизведения в следующем виде:</div>' +
